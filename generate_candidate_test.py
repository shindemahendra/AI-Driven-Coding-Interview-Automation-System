...
def run_candidate_test_generation(full_name: str, email: str, difficulty: str, domain: str):
    """
    ...
    Returns:
        (uid, json_path)
    """
    uid, json_path = _generate_candidate_test(full_name, email, difficulty, domain)
...
if __name__ == "__main__":
    ...
    uid, json_path = run_candidate_test_generation(full_name, email, difficulty, domain)
